          ...
          <div className="gs-platform-sidebar">
            ...
            <div className="gs-sidebar-card">
              ...
              <div className="gs-sidebar-links-list">
                <Link className="gs-sidebar-link" to="https://github.com/nsb-ucsc/nsb_beta">
                  <IconGithub/> NSB on GitHub <IconArrowRight/>
                </Link>
                <Link className="gs-sidebar-link" to="/docs/api">
                  API Documentation <IconArrowRight/>
                </Link>
                <Link className="gs-sidebar-link" to="/docs/examples">
                  Example Applications <IconArrowRight/>
                </Link>
              </div>
            </div>
