  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        sidebarPath: false,
        editUrl: 'https://github.com/nsb-ucsc/nsb/edit/main/tutorials/',
        breadcrumbs: false,
      },
    ],
  ],
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/nsb-ucsc/nsb/edit/main/docs/',
          routeBasePath: 'docs',
        },
        blog: false,
        theme: {
      ...
      links: [
            ...
            items: [
              {
                ...
                <div class="footer-brand">
                  ...
                  <a
                    href="https://github.com/nsb-ucsc/nsb"
                    target="_blank"
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub', href: 'https://github.com/nsb-ucsc/nsb' },
          ],
        },
      ],
